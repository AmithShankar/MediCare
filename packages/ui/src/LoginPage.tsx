      ...
      <div className="hidden lg:flex lg:w-[50%] xl:w-[60%] relative overflow-hidden bg-slate-950">
        ...
        <div className="relative z-20 flex flex-col justify-between p-16 w-full">
              ...
              {[
                {
                  ...
                  sub: "HIPAA & GDPR Compliant architecture",
                },
                {
                  icon: Activity,
                  label: "Real-time Intelligence",
                  sub: "Instant vitals and critical alert system",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="flex items-center gap-5 p-5 rounded-3xl bg-white/[0.03] border border-white/10 backdrop-blur-2xl hover:bg-white/[0.06] transition-all group cursor-default"
                >
          ...
          <motion.div
            ...
            className="flex items-center gap-6 text-slate-500 text-sm font-bold uppercase tracking-[0.2em]"
          >
        ...
        >
          <div className="text-center lg:text-left space-y-2">
            ...
            <p className="text-muted-foreground font-medium">
              Access your hospital's secure dashboard
            </p>
          </div>
          ...
          <div className="premium-card p-10 border-border/60 shadow-2xl shadow-black/5 dark:shadow-black/20">
            <form
              onSubmit={handleSubmit((d) =>
                loginWithEmail(d.email, d.password),
              )}
              className="space-y-6"
            >
              <div className="space-y-2.5">
                <label className="text-[13px] font-bold text-muted-foreground uppercase tracking-wider ml-1">
                  Work Email
                </label>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center">
                <span className="bg-card px-4 text-[10px] font-black uppercase tracking-[0.25em] text-muted-foreground/60">
            ...
            >
              <svg viewBox="0 0 24 24" className="h-6 w-6 shrink-0" aria-hidden>
                ...
                <path
                  fill="#EA4335"
                  d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 2.18 2.18 5.38l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"
                />
              </svg>
              Google
            </button>
