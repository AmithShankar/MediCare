...
const DEMO_NOTIFICATIONS: DemoNotif[] = [
  {
    ...
    message: "David Patel: SpO2 dropped below 90%",
    time: "2 min ago",
    read: false,
  },
  {
    ...
    type: "critical",
    title: "Critical Alert",
    message: "Robert Chen: Blood pressure critically low (88/55)",
    time: "15 min ago",
    read: false,
  },
  {
    ...
    type: "admission",
    title: "New Admission",
    message: "Thomas Murphy admitted to Ward 3B, Bed 318",
    time: "1 hr ago",
    read: true,
  },
  {
    ...
    message: "Sarah Mitchell: follow-up in 30 minutes",
    time: "2 hr ago",
    read: true,
  },
  {
    ...
    message: "Emily Thornton successfully discharged from Ward 1A",
    time: "3 hr ago",
    read: true,
  },
  {
    ...
    message: "Natasha Williams: Chemotherapy panel results available",
    time: "4 hr ago",
    read: true,
  },
];
...
export function NotificationsClient() {
  ...
  useEffect(() => {
    setHeader(
      "Notifications",
      "Monitor real-time system alerts and clinical updates",
    );
  }, [setHeader]);

  useEffect(() => {
    if (sessionStorage.getItem("notif-page-fired")) return;
    const unread = DEMO_NOTIFICATIONS.filter(
      (n) => !n.read && n.type === "critical",
    );
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 premium-card p-4">
        <div className="flex items-center gap-2">
          ...
          >
            Unread
            {unreadCount > 0 && (
              <span className="h-4 min-w-4 flex items-center justify-center bg-destructive text-white rounded-full text-[9px]">
                {unreadCount}
              </span>
            )}
          </button>
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            size="sm"
            onClick={markAllRead}
            className="h-9 px-4 rounded-xl border-border text-xs font-bold uppercase tracking-wider"
          >
